...
#import "AnimationTwoVC.h"
#import "FQCustomAlert.h"
#import "FQCustomModel.h"

@interface AnimationTwoVC ()<FQCustomAlertDelegate>
...
//    [UIView performSystemAnimation:UISystemAnimationDelete onViews:@[self.sportView] options:UIViewAnimationOptionLayoutSubviews animations:^{
//        NSLog(@"--------");
